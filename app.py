...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:anjaliserver.database.windows.net,1433;Database=anjalidb;Uid=anjali;Pwd=#Kashmir@123;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
